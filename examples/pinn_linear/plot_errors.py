...
for net in networks:
    proj_net = project((net(x) - model.ground_truth(x)), model.function_space)
    plot(proj_net)

ax = plt.gca()
ax.lines[-1].set_color("#9467bd")
ax.lines[-2].set_color("#2ca02c")
...
plt.savefig("plots/plot_errors.png", dpi=400, bbox_inches="tight")
